...
// Check if editing
if (!empty($_GET['id'])) {
    $stmt = $db->prepare('SELECT * FROM Bus_Company WHERE id = ? LIMIT 1');
    ...
    if ($c) {
        ...
        $_SESSION['flash_msg'] = '⚠️ Firma bulunamadı.';
    ...
    if (empty($errors)) {
        if (!empty($_POST['id'])) {
            ...
            try {
                ...
                $_SESSION['flash_msg'] = '✅ Firma güncellendi.';
                header('Location: manage_companies.php');
                exit;
            } catch (PDOException $e) {
    ...
    <div class="admin-container">
        ...
        <nav class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li><a href="manage_companies.php" class="active"><i class="fas fa-building"></i> Firmalar</a></li>
